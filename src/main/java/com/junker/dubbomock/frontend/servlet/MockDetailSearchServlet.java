...
import com.junker.dubbomock.frontend.util.JsonStringExchangeUtil;
        ...
        try {
            ...
            for(int i=0;i<count;i++){
                ...
                for(int j=0;j<apicount;j++){
                    ...
                    eachAPIString="{\"id\":\""+id+"\",\"author\":\""+author+"\","+"\"mockType\":\""+mockType+"\","+"\"mockCaseName\":\""+mockCaseName+"\","+"\"mock_timeout\":\""+mock_timeout+"\","+"\"mockCondition\":\""+conditionString+"\","+"\"mockResponseMsg\":"+mockResponseMsg+"}";
                }
